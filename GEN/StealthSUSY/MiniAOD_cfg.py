...
# with command line options: step3 --python_filename MiniAOD_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:MiniAOD.root --conditions 140X_mcRun3_2024_realistic_v26 --step PAT --runUnscheduled --geometry DB:Extended --filein file:RECO.root --era Run3_2024 --no_exec --mc -n 10
